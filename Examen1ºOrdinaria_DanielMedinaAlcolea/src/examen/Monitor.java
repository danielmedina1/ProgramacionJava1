...
public class Monitor extends Persona {
	...
	public void calculaComplementoClases(String mes) {
		...
		try {
			...
			pw.println("*************************************************");
			int numDias = Integer.parseInt(this.getListaClases().get(this.getListaClases().size()-1).getDia());
			for (int i = 1; i <= numDias; i++) {
					...
					//No tengo ni idea de por que no se imprime nada en el fichero
					//Por que elm proceso sale correctamente ya que si le pido
					//los extras estos si han sido asignados correctamente
						pw.println("Dia "+i);
	...
	public static void main(String[] args) {
		Monitor m = new Monitor(null, "Pepito", "Perez", null, null);
